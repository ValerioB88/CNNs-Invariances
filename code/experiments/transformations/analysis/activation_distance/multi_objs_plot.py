"""
Analysis of cossim distance computed with run_distance_fulltrain.ipynb.
This is similar to the multi objects Figure in the main paper. However, here we use the cosine similarity, not the
result from the 5AFT. Results are, however the same (no difference across objects)
"""
